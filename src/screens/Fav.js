...
export default class FavScreen extends Component {
	...
	componentDidMount() {
		const url = `https://api.themoviedb.org/3/discover/movie?api_key=f3e9f7d1677c7aa63c9ab526381eeceb&language=en-US&sort_by=popularity.desc&include_adult=false&include_video=false&page=4`;
		...
		return (
			<View style={{ flex: 1, backgroundColor: '#0D0D0D' }}>
				<View style={styles.header}>
					<Search small />
					<TextInput style={styles.textinput} placeholder="My favorite ADS" />
				</View>
				<FlatList
					data={dataSource}
